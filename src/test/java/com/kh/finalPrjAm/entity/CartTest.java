...
class CartTest {
    ...
    public Member createMemberInfo() {
        ...
        member.setUserId("alice2023");
        member.setPassword("alice2023");
        member.setName("Alice");
        member.setEmail("alice2023@gmail.com");
    ...
    public void findCartAndMemberTest() {
        ...
        System.out.println("장바구니의 entity 회원의 userID : " + saveCart.getMember().getUserId());
        assertEquals(saveCart.getMember().getUserId(), member.getUserId()); // 두개가 같은 경우 성공
